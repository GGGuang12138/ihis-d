...
//        String partnerKey = sysKeyValueService.get(KeyConstant.UPLOAD_PARTNER_KEY);
        ...
        String partnerId = "c9062ae380fbcf83eb9e9c20091aa204";
        String partnerKey = "2ce3d00bb802819a78cb84875695ff8f";
        long time = new Date().getTime();
        String sign = sign(partnerId,time,fileId,partnerKey);
        return FormatUtils.format("{}?partnerId={}&time={}&sign={}&fileId={}",
                fsUrl,partnerId, String.valueOf(time), sign,fileId);
    }
